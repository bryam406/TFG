...
<body style="background-color:;">
    <div class="container" style="margin-top:70px;background-color: white;" >
        ...
        <button  type="button" class="btn btn-outline-dark" onclick="inicio()"  width="30px">
        Descarga PDF</button>
        ...
        <div id="pagina">
            <div class="row">
                ...
                <div class="col-lg-4" style="text-align: center;">
                                  <img src="<?php echo base_url();?>imagenes/Imagen1.png"   height="100px" width="100px">
            ...
            <div class="col-lg-3">
                ...
                <strong ><?php echo($recibos[0]['factura']) ?> </strong>  <br>
        ...
        <div class="row">
           <div class="col-lg-6" >  
              <img src="<?php echo base_url();?>imagenes/ruedas.jpg"  width="40%">

          </div>
          <div class="col-lg-6" style="text-align: center;">  
           <img src="<?php echo base_url();?>imagenes/firma.png"  width="140%">
